...
<div 
    ...
    <button 
        type="button"
        @click="fontSize = 100; highContrast = false; dyslexiaFont = false"
    ...
    <button 
        ...
        :class="dyslexiaFont ? 'bg-blue-500 text-white border-blue-600 ring-2 ring-blue-600' : 'bg-white border-gray-300 text-gray-700 hover:bg-gray-50'"
